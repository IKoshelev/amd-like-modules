...
(function (window) {
    ...
    (function (TreeDictionaryErrorReason) {
        ...
        TreeDictionaryErrorReason[TreeDictionaryErrorReason["LeafAlreadyExists"] = 2] = "LeafAlreadyExists";
    ...
    var TreeDictionary = (function () {
        ...
        TreeDictionary.assignObjToBranchesPath = function (holderObject, branchesPath, obj, throwIfAlreadExists) {
            if (throwIfAlreadExists === void 0) { throwIfAlreadExists = false; }
            ...
            if (throwIfAlreadExists && typeof currentBranchesPathEndObj[finalNamespace] !== 'undefined') {
                var e = new Error("Error adding object to TreeDictionary, object already exists at path " + branchesPath);
                e.reason = TreeDictionary.errorReason.LeafAlreadyExists;
                throw e;
            }
        ...
        TreeDictionary.prototype.addToTree = function (branchesPath, obj, throwIfAlreadExists) {
            if (throwIfAlreadExists === void 0) { throwIfAlreadExists = false; }
        ...
        TreeDictionary.prototype.add = function (branchesPath, obj, throwIfAlreadExists) {
            if (throwIfAlreadExists === void 0) { throwIfAlreadExists = false; }
    ...
    window.simpleDefine = window.simpleDefine || (function (window) {
        var moduleFileInfoResolver = new TreeDictionary();
        ...
        var moduleNamespacesAlreadyProcessedForDependencyFileLoading = {};
        function attemptToLoadDependencyContatiningFiles(moduleNamespace, depenenciesArr) {
            ...
            for (var count1 = 0; count1 < depenenciesArr.length; count1++) {
                ...
                var depToResolve = depenenciesArr[count1];
                function loadOnceIfLoadHasNotBeenRequestedYet(moduleFileInfo) {
                ...
                if (exports.resolveNamedDependenciesInSameNamespaceBranch) {
                    ...
                    var loadReqMade = loadOnceIfLoadHasNotBeenRequestedYet(moduleFileInfo);
                    if (loadReqMade) {
                        continue;
                    }
                }
                if (exports.resolveNamedDependenciesByUniqueLastNamespaceCombination) {
                    var loadReqMade = false;
                    try {
        ...
        exports.useModuleFileInfoMap = function useModuleFileInfoMap(map) {
            for (var count1 = 0; count1 < map.length; count1++) {
