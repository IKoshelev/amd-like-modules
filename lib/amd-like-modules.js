window.simpleDefine = (function (window) {
    ...
    function resolveDependencyByUniqueLastNamespaceCombination(name) {
    ...
    function resolveDependencyInSameNamespaceBranch(dependingModuleNamespace, name) {
        ...
        while (currentNsBranch) {
            var currentSearchPath = currentNsBranch + '.' + name;
            var resolvedDependency_1 = getPropertyByPath(internalNamespaceHolder, currentSearchPath);
            if (resolvedDependency_1) {
                return resolvedDependency_1;
            }
            currentNsBranch = removeLastSegmment(currentNsBranch);
        }
        var resolvedDependency = getPropertyByPath(internalNamespaceHolder, name);
    ...
    function removeLastSegmment(namespaces) {
    ...
    function ensureStoredForLaterResoultuion(moduleNamespace, moduleDependencies, moduleBody) {
    ...
    var exports = function (moduleNamespace, moduleDependencies, moduleBody, allowThrow) {
        ...
        try {
            ...
            ensureStoredForLaterResoultuion(moduleNamespace, moduleDependencies, moduleBody);
